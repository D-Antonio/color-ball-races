(function() {
	...
	testButtons: function(target_touches){
		...
		if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
			var ba = new Image(); ba.src = "img/a.png";
			var bs = new Image(); bs.src = "img/s.png";
			var bd = new Image(); bd.src = "img/d.png";
			var bw = new Image(); bw.src = "img/w.png";
			var bx = new Image(); bx.src = "img/x.png";
